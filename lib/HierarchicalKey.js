...
var HierarchicalKey = function(bytes) {
  ...
  var isnetname = 0;
  networks.forEach(function(curr){
      if(bytes === curr.name) {
          isnetname=1;
          this.version = curr.bip32privateVersion;
      }
  });
  if (isnetname) {
    this.depth = 0x00;
...
HierarchicalKey.prototype.initFromBytes = function(bytes) {
  ...
  for(var x in networks){
	if(this.version == networks[x].bip32privateVersion ){
		  isPrivate = 1;
  	}
	if(this.version == networks[x].bip32publicVersion ){
		  isPublic = 1;
	}
 }
...
HierarchicalKey.prototype.buildExtendedPublicKey = function() {
  ...
  var v = null;
  networks.forEach(function(curr){
      if (this.version===curr.bip32publicVersion || this.version===curr.bip32privateVersion) {
